...
本文是《深度学习理论与实战》草稿中的一章，主要参考了[Reinforcement Learning: An Introduction Second Edition](http://www.incompleteideas.net/book/the-book-2nd.html)。编辑认为引用的内容有些多，因此把这一章内容放到网上。 更多本系列文章请点击<a href='/tags/#强化学习简介系列文章'>强化学习简介系列文章</a>。
 <!--more-->
