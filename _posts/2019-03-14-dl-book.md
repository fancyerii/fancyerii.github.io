...
---
 ...
 国内首本免费的深度学习书籍！涵盖听觉、视觉、语言和强化学习四大领域，深入浅出的理论分析和详尽的代码分析。<span class='zz'>(4/16增加[语音唤醒引擎]({{ site.baseurl }}/books/mycroft-precise)，4/20增加[人脸识别]({{ site.baseurl }}/books/face-recognition))</span>，本文会持续更新，敬请关注！
