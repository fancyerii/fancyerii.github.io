...
---
 ...
 国内首本免费的深度学习书籍！涵盖听觉、视觉、语言和强化学习四大领域，深入浅出的理论分析和详尽的代码分析。<span class='zz'>(3/29更新AlphaGo、AlphaGoZero和AlphaZero;4/8更新文本分类;4/10增加在Docker中使用Tensorflow Serving)</span>
...
#### [在Docker中使用Tensorflow Serving]({{ site.baseurl }}{% post_url 2019-04-10-tfserving-docker %})
