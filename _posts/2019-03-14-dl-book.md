...
---
 ...
 国内首本免费的深度学习书籍！涵盖听觉、视觉、语言和强化学习四大领域，深入浅出的理论分析和详尽的代码分析。<span class='zz'>(5/18增加[用Cycle GAN实现Image to Image Tanslation]({{ site.baseurl }}/books/cycle-gan)；6/5增加[机器翻译]({{ site.baseurl }}/books/mt))</span>，本文会持续更新，敬请关注！
