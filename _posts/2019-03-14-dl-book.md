...
---
 ...
 国内首本免费的深度学习书籍！涵盖听觉、视觉、语言和强化学习四大领域，深入浅出的理论分析和详尽的代码分析。<span class='zz'>( 4/23增加[成分句法分析]({{ site.baseurl }}/books/parser), 4/28增加[Neural Style Transfer]({{ site.baseurl }}/books/neural-style-transfer))</span>，本文会持续更新，敬请关注！
