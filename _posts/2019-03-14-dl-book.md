...
---
 ...
 国内首本免费的深度学习书籍！涵盖听觉、视觉、语言和强化学习四大领域，深入浅出的理论分析和详尽的代码分析。<span class='zz'>(5/7增加[Deep Q-Learning]({{ site.baseurl }}/books/dqn), 5/10增加[依存句法分析]({{ site.baseurl }}/books/depparser)、[基于神经网络的依存句法分析]({{ site.baseurl }}/books/nndepparser))</span>，本文会持续更新，敬请关注！
